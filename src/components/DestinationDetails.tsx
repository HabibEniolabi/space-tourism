...
const DestinationDetails = ({
  ...
  return (
    <div className="w-full max-w-[360px] text-center lg:text-left xl:max-w-[380px]">
      <div className="mb-5 flex items-center justify-center gap-6 lg:justify-start">
        {destinations.map((destination) => {
          const isActive = activeDestination.id === destination.id;
          ...
          return (
            <button
              ...
              onClick={() => onSelectDestination(destination)}
              className={[
                "relative cursor-pointer pb-3 font-barlow-condensed text-[13px] uppercase tracking-[2.2px] text-[#d0d6f9] transition hover:text-white",
      ...
      <p className="mx-auto max-w-[360px] font-barlow text-[15px] leading-[1.7] text-[#d0d6f9] md:text-base md:leading-7 lg:mx-0">
        {activeDestination.description}
      </p>
