...
const Crew = () => {
  ...
  return (
    <section className="relative min-h-[calc(100dvh-88px)] px-6 pb-0 pt-5 text-white md:min-h-[calc(100dvh-96px)] md:px-10 md:pt-8 lg:min-h-[calc(100dvh-128px)] lg:px-[clamp(4rem,8vw,120px)] lg:pt-6">
      <div className="mx-auto flex min-h-[calc(100dvh-88px)] w-full max-w-[1180px] flex-col md:min-h-[calc(100dvh-96px)] lg:min-h-[calc(100dvh-128px)]">
        ...
        <div className="grid flex-1 grid-cols-1 items-end gap-8 pt-10 md:pt-14 lg:grid-cols-[1fr_48%] lg:items-end lg:gap-10 lg:pt-10">
          {/* Text content */}
          ...
          {/* Image stage */}
          <div className="relative z-20 flex min-h-[300px] items-end justify-center md:min-h-[420px] lg:min-h-[520px] lg:justify-end">
