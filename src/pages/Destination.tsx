...
const Destination = () => {
  ...
  return (
    <section className="relative min-h-[calc(100svh-88px)] px-6 pb-8 pt-5 text-white md:min-h-[calc(100svh-96px)] md:px-10 md:pb-10 md:pt-7 lg:min-h-[calc(100svh-128px)] lg:px-[clamp(4rem,8vw,120px)] lg:pb-6 lg:pt-5">
      <div className="mx-auto flex min-h-[calc(100svh-88px)] w-full max-w-[1110px] flex-col md:min-h-[calc(100svh-96px)] lg:min-h-[calc(100svh-128px)]">
        ...
        <div className="grid flex-1 content-center items-center gap-8 pt-8 md:gap-12 md:pt-10 lg:grid-cols-2 lg:gap-20 lg:pt-4">
          <div className="relative z-20 flex justify-center lg:justify-start lg:pl-10">
            <img
